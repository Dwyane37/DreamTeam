        ...
        <div className="user_info resume_item">
          ...
          <div className="content">
            ...
            <div className="info_wrap">
              <div className="info_item">name: {resumeData.userInfo[0]?.name || '未填写'}</div>
              <div className="info_item">Unversity: {resumeData.userInfo[0]?.university || '未填写'}</div>
              <div className="info_item">email: {resumeData.userInfo[0]?.email || '无'}</div>
            </div>
          </div>
        </div>
